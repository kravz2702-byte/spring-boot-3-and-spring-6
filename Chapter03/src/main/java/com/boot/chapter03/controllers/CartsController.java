...
import com.boot.chapter03.hateoas.CartRepresentationModelAssembler;
import com.boot.chapter03.model.Cart;
import com.boot.chapter03.model.Item;
import com.boot.chapter03.service.CartService;
...
public class CartsController implements CartApi {
    ...
    public ResponseEntity<List<Item>> getCartItemsByItemId(String customerId, String itemId) {
        return ok((List<Item>) service.getCartItemsByItemId(customerId, itemId));
    }
}
